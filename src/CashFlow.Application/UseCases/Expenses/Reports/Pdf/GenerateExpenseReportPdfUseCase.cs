...
public class GenerateExpenseReportPdfUseCase : IGenerateExpenseReportPdfUseCase
{
    ...
    public async Task<byte[]> Execute(DateOnly month)
    {
        ...
        foreach (var expense in expenses) {
            ...
            row.Cells[2].AddParagraph(expense.PaymentType.ConvertPaymentType());
            ...
            if (!string.IsNullOrWhiteSpace(expense.Description))
            {
                ...
                descriptionRow.Cells[0].Format.Font = new Font { Name = FontHelper.RALEWAY_REGULAR, Size = 14, Color = ColorsHelper.BLACK };
    ...
    private void CreateTotalSpentSection(Section page, DateOnly month, decimal total)
    {
        ...
        var title = string.Format(ResourcesReportMessages.TOTAL_SPENT_IN, month.ToString("Y"));
    ...
    private void AddExpenseAmount(Cell cell)
    {
        cell.AddParagraph(ResourcesReportMessages.AMOUNT);
